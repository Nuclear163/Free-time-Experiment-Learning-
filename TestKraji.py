...
x1=float(input("Vnesi koordinato x1"))
y1=float(input("Vnesi koordinato y1"))
x2=float(input("Vnesi koordinato x2"))
y2=float(input("Vnesi koordinato y2"))
print(razdalja_koordinat(x1,y1,x2,y2))
